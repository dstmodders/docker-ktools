...
# reference:
#   4.5.1-imagemagick-7.1.2-13-alpine, 4.5.1-alpine, 4.5.1, alpine, latest
#   4.5.1-imagemagick-7.1.2-13-debian, 4.5.1-debian, debian
#   4.5.0-imagemagick-7.1.2-13-alpine, 4.5.0-alpine, 4.5.0
#   4.5.0-imagemagick-7.1.2-13-debian, 4.5.0-debian
print_latest_tags() {
...
# reference:
#   official-4.4.0-imagemagick-6.9.13-38-alpine, official-4.4.0-alpine, official-4.4.0, official-alpine, official-latest, official
#   official-4.4.0-imagemagick-6.9.13-38-debian, official-4.4.0-debian, official-debian
#   official-4.3.1-imagemagick-6.9.13-38-alpine, official-4.3.1-alpine, official-4.3.1
#   official-4.3.1-imagemagick-6.9.13-38-debian, official-4.3.1-debian
print_official_tags() {
